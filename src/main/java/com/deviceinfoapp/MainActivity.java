...
//        fragmentManager.beginTransaction().replace(R.id.content_frame, fragment).commit();
    ...
    public static class ElementPagerAdapter extends FragmentStatePagerAdapter {

        public ElementPagerAdapter(android.support.v4.app.FragmentManager fm) {
            super(fm);
        }
        ...
        public CharSequence getPageTitle(int position) {
            return Elements.NAMES[position];
        }
    }
}
